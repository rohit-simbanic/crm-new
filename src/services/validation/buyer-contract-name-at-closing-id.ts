...
export const buyer_contract_name_at_closing_id = {
    ...
    calculate: (opportunity: ObjectType, originalOpportunity: ObjectType) => {
        if (
            ...
            isEmpty(opportunity?.buyer_contract_name_at_closing_id)
        ) {
            return {
                buyer_contract_name_at_closing_id:
                    opportunity?.account_buyer_id,
                buyer_contract_name_at_closing_name: opportunity?.account_buyer_name,
            };
        } else {
            return {
                buyer_contract_name_at_closing_id:
                    originalOpportunity?.buyer_contract_name_at_closing_id,
                buyer_contract_name_at_closing_name: originalOpportunity?.buyer_contract_name_at_closing_name,
            };
        }
