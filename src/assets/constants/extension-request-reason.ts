...
const extensionRequestReason: ObjectType = {
  ...
  pending_signed_seller_closing_package:
    'Pending Signed Seller Closing Package',
...
export default extensionRequestReason;
